/**
 * Official IDP & Cambridge IELTS Writing Band Descriptors (Bands 0 - 9)
 * Source: https://ielts.idp.com/results/scores/writing
 * Exact verbatim criteria specifications for 100% alignment with official examiner standards.
 */

export const IDP_SCORING_STANDARDS = {
  source: "https://ielts.idp.com/results/scores/writing",
  task_weights: {
    task_1: { weight: "33.3% (1/3)", min_words: 150, recommended_time_mins: 20 },
    task_2: { weight: "66.7% (2/3)", min_words: 250, recommended_time_mins: 40 }
  },
  criteria_weights: {
    task_achievement_or_response: "25%",
...
export const TASK_2_BAND_DESCRIPTORS = {
  "band_9": {
...
export const TASK_1_BAND_DESCRIPTORS = {
  "band_9": {
